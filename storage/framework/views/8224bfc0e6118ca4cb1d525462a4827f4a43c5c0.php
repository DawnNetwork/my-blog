	...
	<div class="menu_box">
		<ul>
            <li>
				...
				<ul class="sub_menu">
					<li><a href="<?php echo e(url('admin/categroy/create')); ?>" target="main"><i class="fa fa-fw fa-plus-square"></i>添加分类</a></li>
					<li><a href="<?php echo e(url('admin/categroy')); ?>" target="main"><i class="fa fa-fw fa-list-ul"></i>分类列表</a></li>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/code/blog/resources/views/admin/index.blade.php ENDPATH**/ ?>