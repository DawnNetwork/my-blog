    ...
    <form action="{{url('admin/article/'.$field->art_id)}}" method="post">
        ...
        <table class="add_tab">
            ...
            <tr>
                <th>缩略图：</th>
                <td>
                    <input type="text" size="50" name="art_thumb" value="{{$field->art_thumb}}" style="float: left;">
                    <link rel="stylesheet" type="text/css" href="/Huploadify-HTML/Huploadify.css"/>
                    <script type="text/javascript" src="/Huploadify-HTML/jquery.Huploadify.js"></script>
                    ...
                    <div id="upload"></div>
                    <style type="text/css">
                        #upload{margin: 0px !important;padding: 0px;line-height: 12px;float: left;}
                        .uploadify{display:inline-block;}
                        .uploadify-button{border:none; border-radius:5px; margin:0px;line-height: 28px;}
                    </style>
                </td>
            </tr>
            <tr>
